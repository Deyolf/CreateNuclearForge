package net.nuclearteam.createnuclear.content.test.fluid;
...
public class BasicFluidTank implements IExtendedFluidTank {
    ...
    public static final Predicate<@NotNull FluidStack> alwaysTrue =  t -> true;
    public static final Predicate<@NotNull FluidStack> alwaysFalse = t -> false;
    public static final BiPredicate<@NotNull FluidStack, @NotNull AutomationType> alwaysTrueBi = (t, u) -> true;
    public static final BiPredicate<@NotNull FluidStack, @NotNull AutomationType> internalOnly = (t, automationType) -> automationType == AutomationType.INTERNAL;
    public static final BiPredicate<@NotNull FluidStack, @NotNull AutomationType> notExternal = (t, automationType) -> automationType != AutomationType.EXTERNAL;
    ...
    private void setStack(FluidStack stack, boolean validateStack) {
        if (stack.isEmpty()) {
            ...
            throw new RuntimeException("Invalid fluid for tank: " + stack.getFluid() + " " + stack.getAmount());
        }
        onContentsChanged();
    }
    ...
    public CompoundTag serializeNBT() {
        ...
        if (!isEmpty()) {
            nbt.put("stored", stored.writeToNBT(new CompoundTag()));
        }
        return nbt;
    }
