...
public class BasicInventorySlot implements IInventorySlot {
    ...
    public static final Predicate<@NotNull ItemStack> alwaysTrue = t -> true;
    public static final Predicate<@NotNull ItemStack> alwaysFalse = t -> false;
    public static final BiPredicate<@NotNull ItemStack, @NotNull AutomationType> alwaysTrueBi = (t, u) -> true;
    ...
    public static final BiPredicate<@NotNull ItemStack, @NotNull AutomationType> internalOnly = (t, automationType) -> automationType == AutomationType.INTERNAL;
    public static final BiPredicate<@NotNull ItemStack, @NotNull AutomationType> notExternal = (t, automationType) -> automationType != AutomationType.EXTERNAL;
    ...
    private void setStack(ItemStack stack, boolean validateStack) {
        if (stack.isEmpty()) {
            ...
            throw new RuntimeException("Invalid stack for slot: " + stack.getItem() + " " + stack.getCount() + " " + stack.getTag());
        }
        onContentsChanged();
    }
    ...
    @Override
    public @Nullable Slot createContainerSlot() {
        return null;
    }
