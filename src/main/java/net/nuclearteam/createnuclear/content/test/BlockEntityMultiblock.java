...
import net.nuclearteam.createnuclear.content.test.interfac.IBlockProvider;
import net.nuclearteam.createnuclear.content.test.interfac.IConfigurable;
import net.nuclearteam.createnuclear.content.test.interfac.multiblock.IMultiblock;
import net.nuclearteam.createnuclear.content.test.interfac.multiblock.Structure;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

import java.util.UUID;

public class BlockEntityMultiblock<T extends MultiblockData> extends BlockEntity implements IMultiblock<T>, IConfigurable {
    ...
    public BlockEntityMultiblock(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
